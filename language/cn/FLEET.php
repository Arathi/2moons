...
$LNG['sys_ship_type'] 						= "类型";
$LNG['sys_ship_count'] 						= "数量";
$LNG['sys_ship_weapon'] 					= "火力";
$LNG['sys_ship_shield'] 					= "护盾";
$LNG['sys_ship_armour'] 					= "装甲";
$LNG['sys_destroyed'] 						= "摧毁";
$LNG['fleet_attack_1'] 						= "攻击方使用了";
$LNG['fleet_attack_2']						= "朝防御方开火。防御方的护盾吸收了";
$LNG['fleet_defs_1'] 						= "攻击方使用了";
$LNG['fleet_defs_2']						= "朝攻击方开火。攻击方的护盾吸收了";
$LNG['damage']								= "点伤害值.";
$LNG['sys_attacker_won'] 					= "攻击方赢得了这场战斗！";
$LNG['sys_defender_won'] 					= "防御方赢得了这场战斗！";
$LNG['sys_both_won'] 						= "这场战斗以双方战平结束。";
$LNG['sys_stealed_ressources'] 				= "俘获了";
$LNG['sys_and']								= "而且";
$LNG['sys_mess_tower'] 						= "舰队司令部";
...
$LNG['sys_mess_head'] 					    = '间谍卫星报告 %s [%d:%d:%d] on %s';
...
$LNG['sys_colo_mess_report'] 				= "殖民报告";
$LNG['sys_colo_defaultname'] 				= "殖民地";
$LNG['sys_colo_notech'] 					= '我方一支舰队到达了坐标为 %s 的地区。当移居者靠近这颗行星时， they had to determine that their equipment still not for the prevailing climate was suitable and must be developed first. 他们失望地返航了。';
...
$LNG['sys_expe_found_ress_1_1']				= '您的探险队发现了一个小行星群，并获取到了一些资源。';
...
$LNG['sys_expe_found_ress_1_4']				= '您的探险队发现了一颗大气中弥漫着剧毒、被辐射严重污染的行星。不过经过勘探，该星球上蕴含着大量未开采的矿物。It was mined by automatic drones to win a maximum of raw materials. ';
$LNG['sys_expe_found_ress_2_1']				= '您的探险队发现了一艘载满货物的老式的运输机，不过不知道什么原因，这艘飞船似乎被遗弃了。我们从中获取到了一些资源。';
$LNG['sys_expe_found_ress_2_2']				= '您的探险队发现了一颗有大气层的小卫星，而且上面储备着大量资源。船员们正准备搬运走这笔宝藏。';
$LNG['sys_expe_found_ress_2_3']				= '我们遇到了一支民用飞船小队，他们急需食品和药物。作为交换，我们获得了一些有用的资源。';
$LNG['sys_expe_found_ress_3_1']				= '您的探险队报告说 Your expedition fleet reported the find of a gigantic alien shipwreck. But the ships were of no purpose because its technology, however the ship could be chopped into pieces for its components so the crew could win valuable raw materials.';
$LNG['sys_expe_found_ress_3_2']				= '发现了一颗不知名称的星球的小行星带上蕴含着浩瀚的资源。探险队满载而归！';
$LNG['sys_expe_found_dm_1_1']				= '您的探险队成功的获取到了一些暗物质。';
$LNG['sys_expe_found_dm_1_2']				= '我们的探险队发现了一艘幽灵船， Our expedition has discovered a ghost ship, which transported a small amount of dark matter. Although we have not been able to find notes on what has happened to the original crew, our technicians, however, managed to get hold of the dark matter.';
...
$LNG['sys_expe_found_dm_1_4']				= '我们发现了一艘外星飞船的残骸，在这艘飞船上，我们找到了一个装着暗物质的小容器！';
$LNG['sys_expe_found_dm_1_5']				= 'The expedition followed some strange signals and discovered an asteroid, in the core was a small amount of dark matter detected. The asteroid was taken on board and 科研人员提取出了暗物质。';
$LNG['sys_expe_found_dm_2_1']				= '我们的探险队在一次实验中获得成功。您现在可以从一颗枯竭的星体中获取到暗物质。';
...
$LNG['sys_expe_found_dm_3_1']				= '您的探险队被卷入了扭曲空间中，但在这个源生超空间内以外发现了大量的暗物质！';
...
$LNG['sys_expe_found_ships_1_2']			= '我们发现了一个被遗弃的海盗基地。一些破旧的飞船仍停在机库中。专家们鉴定后认为，其中一些飞船还能使用。';
$LNG['sys_expe_found_ships_1_3']			= '我们的探险队发现了一个在某次战争中几乎被摧毁掉的行星。各种各样的飞船残骸绕着卫星轨道漂移着。专家正在尝试修复其中一部分飞船部件。也许我们可以发现这里过去发生了些什么。';
$LNG['sys_expe_found_ships_1_4']			= '探险队发现了一个似乎已经被遗弃了非常久的星际基地。在堡垒中的机库中发现了一些飞船。技术人员尝试使它们再度飞行。';
$LNG['sys_expe_found_ships_2_1']			= '我们发现了一个舰队的遗留物。探险队的技术人员们立即去修复那些看起来稍微完好的飞船。';
$LNG['sys_expe_found_ships_2_2']			= '我们的探险队发现了一个老旧的造船厂。有些飞船仍停留在生产阶段，而我们的技术人员在试图将他们完成，建造飞船所需的电量供应系统应该优先恢复。';
$LNG['sys_expe_found_ships_3_1']			= '我们发现了一个巨大的飞船墓地。我们探险队中的技术人员试图去修复那些废船，使它们再度工作。';
$LNG['sys_expe_found_ships_3_2']			= '我们在一个星球上发现了一个文明留下的遗迹。在上面还找到了一个巨大的机场。我们的一些技术人员和船员前去停机坪去看个究竟，也许我们可以多带回几艘船。';
...
$LNG['sys_expe_nothing_9'] 					= '旗舰的反应堆发生了故障，差点毁掉了整支探险队。幸好技术人员及时阻止了更糟糕的事态的发生。A reactor malfunction on the  commandship almost destroyed the complete expedition. Fortunately the technicians were more than capable and could prevented the worst. The repair however, took so much time that the expedition returned without achieving anything.'; 	
$LNG['sys_expe_attack_1_1_1'] 				= '一群宇宙海盗试图强占我们的探险舰队。';
...
$LNG['sys_expe_attack_1_1_3'] 				= 'We have intercepted a couple of radio messages of some very drunk pirates. 我们显然要遭到袭击了。';
$LNG['sys_expe_attack_1_1_4'] 				= '我们与一直数量上超过我们的宇宙海盗发生了正面冲突。';
...
$LNG['sys_expe_attack_1_2_1'] 				= '您的探险队意外地遭遇了宇宙海盗，并与之发生了遭遇战。';
...
$LNG['sys_expe_attack_2_2_1'] 				= '我们的探险队遭到了不明种族的袭击！';
...
$LNG['sys_expe_attack_2_2_3'] 				= '我们与探险队的通信连接突然间中断，失去联络前他们提到了遭到了严重打击——没有识别出是谁攻击了我们。';
$LNG['sys_expe_attack_2_3_1'] 				= '您的探险队遭遇了一直外星侵略舰队，并报告了重大的战况！';
...
$LNG['type_mission'][11]  					= '调查'; //DM
$LNG['type_mission'][15] 					= '探险'; //考查、探险、远征
